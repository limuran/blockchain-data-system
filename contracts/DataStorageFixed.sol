...
contract DataStorage {
    ...
    function storeData(string memory data, string memory dataType) public {
        ...
        bytes32 dataHash = keccak256(abi.encodePacked(data, dataType, msg.sender, block.timestamp));
    ...
    function getDataByType(string memory dataType) public view returns (uint256[] memory) {
    ...
    // 批量查询最新数据
    function getLatestEntries(uint256 count) public view returns (DataEntry[] memory) {
